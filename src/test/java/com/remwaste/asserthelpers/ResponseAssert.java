package com.remwaste.asserthelpers;
...
public class ResponseAssert extends AbstractAssert<ResponseAssert, Response> {
     ...
     * @param clas the class object representing the type to deserialize to
     * @return the current instance of {@code ResponseAssert} for method chaining
     */
    public <T> ResponseAssert canBeDeserializedTo(Class<T> clas) {
        softAssertions
                .assertThatCode(()-> actual.as(clas))
                .withFailMessage("Response cannot be deserialized to " + clas.getName())
